//thanks to https://morioh.com/p/7cdf8ae19878
// DOM Elements
...
const checkStatusOfGame = (cell) => {
  //if 4 or more in a row or column
...
const handleCellClick = (e) => {
  ...
  //fill up the cell and give it a class
